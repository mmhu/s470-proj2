...
# Not sure, and add interaction maybe?
test.logit <- glm(cbind(count, count0) ~ gender + sport + year, 
...
# Not sure about upper and lower calculation
...
lower <- exp(sport.co[2:5, 1] - 4 * sport.co[2:5, 2])
upper <- exp(sport.co[2:5, 1] + 4 * sport.co[2:5, 2])
